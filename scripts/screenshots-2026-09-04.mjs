...
const tasks = [
  { url: 'https://github.com/2akouwu/reverify', dir: 'reverify-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/Human-Agent-Society/reef', dir: 'reef-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/lnkiai/m3e-canvas', dir: 'm3e-canvas-review-2026', kind: 'reviews', wait: 15000 },
];
