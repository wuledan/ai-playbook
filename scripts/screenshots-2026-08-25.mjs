...
const tasks = [
  { url: 'https://github.com/ShadowAqueduct/watermark-remover', dir: 'watermark-remover-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/duty1g/x64dbg-mcp-server', dir: 'x64dbg-mcp-server-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/microsoft/agent-lightning', dir: 'agent-lightning-v1-review-2026', kind: 'reviews', wait: 15000 },
];
