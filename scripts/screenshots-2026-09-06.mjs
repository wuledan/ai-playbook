...
const tasks = [
  { url: 'https://github.com/Albert-Weasker/niubigeo', dir: 'niubigeo-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/ahujasid/camera-to-blender', dir: 'camera-to-blender-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/tigerless-labs/agent-memory', dir: 'agent-memory-review-2026', kind: 'reviews', wait: 15000 },
];
