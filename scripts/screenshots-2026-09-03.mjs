...
const tasks = [
  { url: 'https://github.com/anthropics/commerce-agents', dir: 'commerce-agents-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/carloslfu/slotstream', dir: 'slotstream-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/ZJU-REAL/Easel', dir: 'easel-review-2026', kind: 'reviews', wait: 15000 },
];
