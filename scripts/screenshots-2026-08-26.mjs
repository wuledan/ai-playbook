...
const tasks = [
  { url: 'https://github.com/localai-org/kimodo.cpp', dir: 'kimodo-cpp-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/amagine-ai/Amagine3D', dir: 'amagine3d-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/kunchenguid/backpass', dir: 'backpass-review-2026', kind: 'reviews', wait: 15000 },
];
