...
const tasks = [
  { url: 'https://github.com/hsandhu/mobilecode', dir: 'mobilecode-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/achimala/dream-loop', dir: 'dream-loop-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/wz1119/Codex-Minecraft-Gameplay', dir: 'codex-minecraft-gameplay-review-2026', kind: 'reviews', wait: 15000 },
];
