...
const tasks = [
  { url: 'https://kagi.com/changelog', dir: 'kagi-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/adnanakil/nobuzz', dir: 'nobuzz-review-2026', kind: 'reviews', wait: 15000 },
  { url: 'https://github.com/browser-use/macos-harness', dir: 'macos-harness-tutorial-2026', kind: 'tutorials', wait: 15000 },
];
